...
public class Get11 extends GoRestApiBaseUrl {
        /*
            ...
            And
                The "current link" shopuld be https://gorest.co.in/public/v1/users?page=1",
            And
                The number of users should be 31
            And
                The number of "active  users" should be 9
            And
                "Indra Ganaka", "Sarada Mehrotra", "Jagathe Chopra" ara among the users
            And
...
//        JsonPath json = response.jsonPath();
        ...
        response.
                ...
                assertThat().
                statusCode(200).
                body("meta.pagination.limit", equalTo(20), "meta.pagination.links.current",
                        equalTo("https://gorest.co.in/public/v1/users?page=1"),"data.id", hasSize(20),
